...
@onready var sprite: Node3D = $"SubViewportContainer/SubViewport/Normal Asteroid"
...
@onready var camera: Camera3D = $SubViewportContainer/SubViewport/Camera3D_regular_Asteriod
